...
public class TheatreAdminService 
{
	...
	public ResponseEntity<ResponseStructure<TheatreAdminDto>> saveAdmin(TheatreAdminEntity theatreAdmin){
	...
	public ResponseEntity<ResponseStructure<TheatreAdminDto>> updateAdmin(TheatreAdminEntity theatreAdmin,int theatreAdminId)
	{
		...
		TheatreAdminDto taDto=new TheatreAdminDto();
		ModelMapper mapper=new ModelMapper();
		mapper.map(theatreAdminDao.updateTheatreAdmin(theatreAdmin,theatreAdminId), taDto);
		ResponseStructure<TheatreAdminDto> structure=new ResponseStructure<TheatreAdminDto>();
